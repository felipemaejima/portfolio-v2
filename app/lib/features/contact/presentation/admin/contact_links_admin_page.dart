...
class ContactLinksAdminPage extends ConsumerWidget {
  ...
  Future<void> _edit(
    ...
    final input = await showDialog<ContactLinkInputDto>(
      context: context,
      builder: (_) => _LinkDialog(initial: item),
    );
    ...
    try {
      ...
      await (item == null
          ...
          : editor.updateLink(item.id, input));
    } on Object catch (e) {
      if (context.mounted) {
        notify(
          context,
            ...
            trailing: IconButton(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  if (context.mounted) {
                    notify(context, failureText(l10n, e), error: true);
                  }
                }
              },
            ),
...
class _LinkDialogState extends State<_LinkDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(
        widget.initial == null ? l10n.newContactLink : l10n.editContactLink,
      ),
      content: SizedBox(
        width: 480,
        child: Column(
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                labelText: l10n.contactLinkLabel,
                hintText: 'GitHub',
              ),
            ),
            ...
            TextField(
              controller: _value,
              decoration: InputDecoration(
                labelText: l10n.contactLinkValue,
                hintText: 'github.com/usuario',
              ),
            ),
            const SizedBox(height: 12),
            TextField(
              controller: _url,
              decoration: InputDecoration(
                labelText: l10n.contactLinkUrl,
                hintText: 'https://… · mailto:… · tel:…',
              ),
            ),
          ],
        ),
