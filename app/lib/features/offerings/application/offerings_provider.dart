...
final offeringsProvider = FutureProvider<List<OfferingDto>>((ref) => ref.watch(offeringsRepositoryProvider).list());
...
class OfferingsEditor {
  ...
  Future<void> update(String id, OfferingInputDto body) => _then(() => _repo.update(id, body));
