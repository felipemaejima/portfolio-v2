...
class OfferingsAdminPage extends ConsumerWidget {
  ...
  Future<void> _edit(
    ...
    final input = await showDialog<OfferingInputDto>(
      context: context,
      builder: (_) => _OfferingDialog(initial: item),
    );
...
class _OfferingDialogState extends State<_OfferingDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(
        widget.initial == null ? l10n.newOffering : l10n.editOffering,
      ),
      content: SizedBox(
        width: 480,
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 4,
              decoration: InputDecoration(
                labelText: l10n.offeringDescription,
