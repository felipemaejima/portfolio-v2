...
final skillCategoriesProvider = FutureProvider<List<SkillCategoryDto>>(
...
class SkillsEditor {
  ...
  Future<void> createCategory(String name) =>
      _then(() => _repo.createCategory(name));
  Future<void> renameCategory(String id, String name) =>
      _then(() => _repo.updateCategory(id, name));
  Future<void> deleteCategory(String id) =>
      _then(() => _repo.deleteCategory(id));
  Future<void> reorderCategories(List<String> ids) =>
      _then(() => _repo.reorderCategories(ids));
  Future<void> createSkill(String categoryId, String name) =>
      _then(() => _repo.createSkill(categoryId, name));
  Future<void> updateSkill(String id, String name, String categoryId) =>
      _then(() => _repo.updateSkill(id, name, categoryId));
  Future<void> deleteSkill(String id) => _then(() => _repo.deleteSkill(id));
  Future<void> reorderSkills(String categoryId, List<String> ids) =>
      _then(() => _repo.reorderSkills(categoryId, ids));
}
